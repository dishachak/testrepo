...
def generate_launch_description():
    ...
    # Add a 20-second delay before starting RViz
    delayed_rviz_node = TimerAction(
        period=10.0,  # Delay of 20 seconds
        actions=[rviz_node],
    )

    # Add a 5-second delay for motion_capture_tracking_node
    delayed_motion_capture_node = TimerAction(
    ...
    return LaunchDescription([
        ...
        delayed_motion_capture_node,  # Add the delayed motion_capture_tracking_node here
        Node(
            package='crazyflie',
            executable='teleop',
            name='teleop',
        ...
        delayed_rviz_node,  # Add the delayed RViz node here
    ])